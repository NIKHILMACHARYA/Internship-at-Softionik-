...
import { DeleteImg, image_list } from '../../actions/imageAction';
...
const ImageView = () => {
    ...
    const { imagedetail} = values;
    useEffect(() => {
        loadImageDetails();
    }, []);

    const loadImageDetails = () => {
        image_list().then(data => {
            ...
            if (data.error) {
                ...
                setValues({ ...values, imagedetail: data.image_list });
            }
        })
    }
    ...
    {
        return (
            <img src={row.image_url} alt="Image not found" height="75px" width="100px" style={{borderRadius:"0%"}}></img>
        )
    }
            ...
            const handleClick = e => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let query = { "img_id": row._id }
                        DeleteImg(query).then(data => {
                            loadImageDetails();
                        });
                    }
                })
                ...
                <div className="content">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-12" style={{ position: "fixed", zIndex: "1" }}>
                                <div className="page-title-box">
                                    <h4 className="page-title float-left">Image List</h4>
                                    <ol className="breadcrumb float-right" style={{ marginRight: "300px" }}>
                                        ...
                                        <li className="breadcrumb-item active">Image List</li>
                                    </ol>
                        ...
                        <div className=''>
                            <div className='col-md-12'>
                                <div className='card-box'>
                                    <Link href='/image/addImage'><a><span className="btn waves-effect waves-light " style={{ backgroundColor: "#38AF00" }}><i className="fe-plus"></i> Add Image</span></a></Link>
                                </div>
                            </div>
                        ...
                        <div className="col-md-12">
                            <div className="card-box">
                                <div style={{ width: '98%' }}>
                                    <BootstrapTable data={imagedetail} cellEdit={cellEditProp} pagination search dataSort striped hover>
                                        <TableHeaderColumn width='100px' dataField='sno' dataAlign="center" dataSort isKey>S.No</TableHeaderColumn>
                                        <TableHeaderColumn width='150px' dataField='image_name' dataAlign="center" editable={false} dataSort>Image Name</TableHeaderColumn>
                                        <TableHeaderColumn width='150px' dataField='image_url' dataAlign="center" editable={false} dataSort dataFormat={displayImage} >Display Image</TableHeaderColumn>
                                        <TableHeaderColumn width='80px' dataField='_id' dataAlign="center" editable={false} dataFormat={edit}>Edit</TableHeaderColumn>
                                        <TableHeaderColumn width='80px' dataField='_id' dataAlign="center" editable={false} dataFormat={deleteImg}>Delete</TableHeaderColumn>
