...
import { image_list_byid} from '../../actions/imageAction';
...
const ImageEdit = () => {
    ...
    const image_id=router.query._id;
    ...
    useEffect(() => {
       ...
       const loadImageDetails = () => {
           image_list_byid(image_id).then(data => {
               ...
               if (data.error) {
                   ...
                   setValues({ ...values, image_name: data.image_list[0].image_name,image_url: data.image_list[0].image_url});
               }
           })
       }
    ...
    const handleSubmit = (e) => {
        ...
        // alert(FormData);
        axios.post(`${API}/edit_image`, formData, {
        }).then(res => {
            //loadDetails();
                        ...
                        <div className="row">
                            <div className="col-12" style={{ position: "fixed", zIndex: "1" }}>
                                <div className="page-title-box">
                                    <h4 className="page-title float-left">Image Edit</h4>
                                    <ol className="breadcrumb float-right" style={{ marginRight: "300px" }}>
                                        ...
                                        <li className="breadcrumb-item active">Image Edit</li>
                                    </ol>
                                ...
                                <div className="card-box" style={{ paddingBottom: "50px" }}>
                                    ...
                                    <form role="form" onSubmit={handleSubmit} >
                                        <div className="form-group">
                                            ...
                                            <input type="text" value={image_name} className="form-control" placeholder="Image Name" id="image_name" name="image_name" onChange={handleChange('image_name')} required />
                                        </div>

                                        <div className="form-group">
                                            <label htmlFor="text">Image </label><br></br>
                                            <img src={image_url} alt="Image not found" height="200px" width="250px" style={{borderRadius:"0%"}}></img>
                                         </div>
