...
import { Delete_State, state_list } from '../../actions/stateAction';
        ...
        const handleClick = e => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let query = { "st_id": row._id}
                    Delete_State(query).then(data => {
                        loadStateDetails();
                    });
                }
            })
                ...
                <div className="content">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-12" style={{ position: "fixed", zIndex: "1" }}>
                                <div className="page-title-box">
                                    <h4 className="page-title float-left">State List</h4>
                        ...
                        <div className=''>
                            <div className='col-md-12'>
                                <div className='card-box'>
                                    <Link href='/state/addState'><a><span className="btn waves-effect waves-light " style={{ backgroundColor: "#38AF00" }}><i className="fe-plus"></i> Add State</span></a></Link>
                                </div>
                            </div>
                        ...
                        <div className="col-md-12">
                            <div className="card-box">
                                <div style={{ width: '98%' }}>
                                    <BootstrapTable data={statedetail} cellEdit={cellEditProp} pagination search dataSort striped hover>
                                        ...
                                        <TableHeaderColumn width='80px' dataField='_id' dataAlign="center" editable={false} dataFormat={Delete_St}>Delete</TableHeaderColumn>
                                    </BootstrapTable>
                                </div>
                            </div>
                        </div>
