...
const CityAdd = () => {
    ...
    const handleSubmit = (e) => {
        ...
        var city_data={city_name,state_id}
        add_city(city_data).then(res => {
                        ...
                        <div className="row">
                            <div className="col-12" style={{ position: "fixed", zIndex: "1" }}>
                                <div className="page-title-box">
                                    <h4 className="page-title float-left">City Add</h4>
                                    <ol className="breadcrumb float-right" style={{ marginRight: "300px" }}>
                                        ...
                                        <li className="breadcrumb-item active">City Add</li>
                                    </ol>
                                ...
                                <div className="card-box" style={{ paddingBottom: "50px" }}>
                                    ...
                                    <form role="form" onSubmit={handleSubmit} >
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" placeholder="City Name" id="" name="city_name" onChange={handleChange('city_name')} required />
                                        </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select className="form-control" id="state_id" name="state_id" onChange={handleChange('state_id')} required disabled={!country_id}>
